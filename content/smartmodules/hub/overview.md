...
Users can download SmartModules to use with multiple clusters. Once downloaded, multiple SmartModules can be chained together to build powerful data transformation pipelines.
