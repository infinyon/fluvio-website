...
To run the java tests, run `./gradlw test`. This won't test that we've hooked
...
fail. Let's verify that this actually fails. Do this by running `./gradlw test`. It should fail with the following assertion error:
```
$ ./gradlew test
