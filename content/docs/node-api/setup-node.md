...
In this guide we’ll cover how to set up your {{< target-blank title="Node.js" url="https://nodejs.org" >}} data streaming environment.
...
| Linux     | Use the instructions provided by your package manager. <br/> Node.js maintains a list of supported packages {{< target-blank title="here" url="https://nodejs.org/en/download/package-manager" >}}.  |
{{< /api-table >}}
