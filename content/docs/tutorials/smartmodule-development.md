...
{{<code-highlight file="code-blocks/rust/regex-filter/Cargo.toml" lang="rust" lines="15">}}

And you can copy/paste this code into the `lib.rs` of the generated SmartModule project.

{{<code file="code-blocks/rust/regex-filter/src/lib.rs" lang="rust" copy="true">}}
...
{{<code file="code-blocks/rust/regex-filter/SmartModule.toml" lang="toml">}}
