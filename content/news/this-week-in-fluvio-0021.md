...
Previously, if you were [developing your own connector]({{<ref "/connectors/how-to/overview">}}), creating connectors would fail because during the creation of the connector pod, Kubernetes would always try to pull from Docker Hub.
